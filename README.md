...
Toma titulares desde **NewsAPI**, los reescribe con **OpenAI** para darles un estilo claro y objetivo, y los publica usando la API de **Twitter (Tweepy)**.
...
- Publica automáticamente en tu cuenta de Twitter (X).  
