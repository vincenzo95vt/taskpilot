...
def rewrite_news(title: str, description: str = "") -> str:
    ...
    El tuit debe ser conciso, claro y atractivo, con un máximo de 840 caracteres. No pongas hashtags ni emojis. y bajo ningun concepto te pases de esos 840 caracteres
    """
